...
class RepositionTask(script: DerangedArchaeologistMagicKiller) : Task(script) {
    ...
    override fun validate(): Boolean {
        ...
        val inFightArea = player.tile().distanceTo(Constants.BOSS_TRIGGER_TILE) <= Constants.FIGHT_AREA_DISTANCE
        val bossIsGone = script.getBoss() == null
        val prayerIsOff = !Prayer.prayerActive(Constants.REQUIRED_PRAYER)
